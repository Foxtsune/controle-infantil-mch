	...
	<div class="container">
        <div id="page-content-wrapper">
            <section class="container-fluid text-center">
                <h1 class="mb-3">Cadastrar Candidato</h1>
	                ...
	                <div class="row my-md-2"> 
	                    <div class="col-md-8 col-sm-12">
	                    	<div class="input-group mb-md-3 mb-sm-1">
							  ...
							  <input type="text" required class="form-control" id="nome" name="nome" aria-describedby="basic-addon-name">
							</div>                      
	                    </div>
					...
					<div class="row my-md-2"> 
	                    <div class="col-md-4 col-sm-12">
	                    	<div class="input-group mb-md-3 mb-sm-1">
							  ...
							  <input type="text" required class="form-control" id="tel" name="tel" aria-describedby="basic-addon-tel">
							</div>                      
	                    </div>
	                    <div class="col-md-4 col-sm-12">
	                    	<div class="input-group mb-md-3 mb-sm-1">
					...
					<div class="row my-md-2"> 
	                    <div class="col-md-5 col-sm-12">
	                    	<div class="input-group mb-md-3 mb-sm-1">
							  ...
							  <input type="neigborhood" required class="form-control" id="neigborhood" name="neigborhood" aria-describedby="basic-addon-neigborhood">
							</div>
	                    </div>
	                    <div class="col-md-5 col-sm-12">
	                    	<div class="input-group mb-md-3 mb-sm-1">
